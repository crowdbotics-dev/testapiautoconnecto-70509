...
## Project Structure
    ...
    ├── testapiautoconnecto_70509  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_70509`
...
2. Clone this repo and `cd testapiautoconnecto_70509`
